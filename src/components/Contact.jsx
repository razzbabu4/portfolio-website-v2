        ...
        <div className="text-gray-50">
          <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
            ...
            <form action="https://getform.io/f/bwnggqma" method="POST" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
              ...
              <button type="submit" className="px-6 py-2 self-center text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-gradient-to-r from-cyan-500 to-blue-500 text-white hover:scale-110">Send</button>
            </form>
          </div>
        </div>
      </div>
